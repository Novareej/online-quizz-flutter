...
import 'package:online_quizz/my_shared.dart';
import 'package:online_quizz/screens/register.dart';
...
class _LoginState extends State<Login> {
  ...
  Future login(
    ...
    var apiCall =
        await Dio().post(Api.baseUrl + Api.utils + Api.login, data: data);
    ...
    if (decode[3] == "Successfully login") {
      ...
      showDialog(
          ...
          builder: (context) {
            return AlertDialog(
              title: Text(
                'Please double check your name or password',
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                          ...
                          padding: EdgeInsets.only(
                              top: 14, bottom: 14, right: 40, left: 40),
